          ...
          <MasonryTileGridContainer numOfCols={3}>
            ...
            <MasonryTile colEnd={1} colStart={1}>
              <ImageSelector
                ...
                description="Create a new booking here!" imgSrc="https://www.hp.com/us-en/shop/app/assets/images/uploads/prod/12%20Best%20Appointment%20Booking%20Apps%20HERO1627253223960628.jpg" title="Create Appointments" />
            </MasonryTile>
            <MasonryTile colEnd={2} colStart={2}>
              <ImageSelector
                href={process.env.REACT_APP_MY_EC2_ADDRESS + "Dashboard"}
            ...
            <MasonryTile colEnd={3} colStart={3}>
              <ImageSelector
                href={process.env.REACT_APP_MY_EC2_ADDRESS + "ViewMyAppointment"}
  
                description="Click here to view all my bookings." imgSrc="http://bookinjiffy.com/wp-content/uploads/2020/08/calandar-digital-laptop-phone-760.jpg" title="View My Appointments" />
            </MasonryTile>
