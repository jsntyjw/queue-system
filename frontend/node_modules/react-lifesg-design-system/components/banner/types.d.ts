...
export declare type VideoBannerType = "default" | "custom";
export interface VideoBannerActionProps extends React.HTMLAttributes<HTMLAnchorElement> {
    children: string;
...
export interface VideoTitleProps extends React.HTMLAttributes<HTMLHeadingElement> {
}
export interface VideoDescriptionProps extends React.HTMLAttributes<HTMLSpanElement> {
}
export {};
