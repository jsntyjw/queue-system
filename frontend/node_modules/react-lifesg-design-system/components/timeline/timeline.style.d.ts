...
export declare const CircleIndicator: import("styled-components").StyledComponent<"div", any, CircleIndicatorProps, never>;
...
export declare const TimelineTitle: import("styled-components").StyledComponent<"h3", any, import("../types").TextProps, never>;
...
export declare const TimelineItemTitle: import("styled-components").StyledComponent<"h4", any, import("../types").TextProps, never>;
export declare const TimelinePills: import("styled-components").StyledComponent<"h3", any, import("../types").TextProps, never>;
