...
export declare const LabelText: import("styled-components").StyledComponent<"h3", any, import("../types").TextProps, never>;
...
export declare const HandleLabel: import("styled-components").StyledComponent<"h4", any, import("../types").TextProps, never>;
export declare const HandleIconContainer: import("styled-components").StyledComponent<"div", any, StyleProps, never>;
export declare const HandleIcon: import("styled-components").StyledComponent<({ type, ...props }: import("../types").IconProps) => JSX.Element, any, {}, never>;
export {};
